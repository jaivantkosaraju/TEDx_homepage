    ...
    <div className="group p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl transform transition-all duration-300 hover:-translate-y-2">
      <div className="relative">
        ...
        <div className="relative bg-white rounded-lg p-6">
          <Users className="w-16 h-16 text-red-500 mb-4 transform transition-transform group-hover:scale-110 group-hover:rotate-12" />
          <h3 className="text-2xl font-bold mb-4 text-gray-900">OUR SPEAKERS</h3>
          <p className="text-gray-600 leading-relaxed">
            Meet the visionaries who are shaping the future through their ideas.
          </p>
        </div>
      </div>
    </div>
